...
public:
    ...
    */
    ...
    void operator()(expr* fml, app_ref_vector& vars, bool& is_fa, expr_ref& result, bool use_fresh = true);
    ...
    */
    void pull_exists(expr* fml, app_ref_vector& vars, expr_ref& result, bool use_fresh = true);
    ...
    */
    void pull_quantifier(bool is_forall, expr_ref& fml, app_ref_vector& vars, bool use_fresh = true);
    ...
    */
    ...
    unsigned pull_quantifier(bool is_forall, expr_ref& fml, ptr_vector<sort>* sorts, svector<symbol>* names, bool use_fresh = true);
